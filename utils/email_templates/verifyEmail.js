...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body style="width: 100% !important; height: 100%; -webkit-text-size-adjust: none; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; background-color: #F4F4F7; color: #51545E; margin: 0;" bgcolor="#F4F4F7">
    <span class="preheader" style="display: none !important; visibility: hidden; mso-hide: all; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; opacity: 0; overflow: hidden;">Thanks for trying out Ahia Marketplace. Use this code to verify your email address.</span>
                  ...
                  <tr>
                    <td class="content-cell" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 35px;">
                      <div class="f-fallback">
                        <h1 style="margin-top: 0; color: #333333; font-size: 30px; font-weight: bold; text-align: left;" align="left">Use this code to verify your email</h1>
                        <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">Hello,<br />Your code is: </p>
                        <!-- Verification Code -->
                        <p style="font-size: 30px; line-height: 1.625; color: #ff0000; margin: .4em 0 1.1875em;">${code}</p>                        
                        <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">Use the code above to verify your email address and complete your registration.<strong>This code is only valid for 10 minutes.</strong><br />After verification, you will be able to modify your password, email address and phone number.</p>
                        <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">Didn't request this verification code? Please secure your account by changing your password. In order to protect your account security, please do not allow others to access your email.</p>
